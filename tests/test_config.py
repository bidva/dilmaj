...
class TestConfig:
    ...
    def test_get_page_range_defaults(self):
        """Test page range calculation with defaults."""
        config = Config()
    ...
    def test_get_page_range_start_greater_than_end(self):
        ...
        with pytest.raises(ValueError, match="Start page 15 cannot be greater than end page 10"):
            config.get_page_range(20)
    ...
    def test_get_page_range_validation_start_greater_than_end(self):
        ...
        with pytest.raises(ValueError, match="Start page 20 cannot be greater than end page 10"):
            config.get_page_range(100)
